	...
	<div class="page-content">
		<div class="container-fluid">			
			<script type="text/javascript">
			  ...
			  xmlhttp.onreadystatechange=function()
			  {
			  	if (xmlhttp.readyState==4 && xmlhttp.status==200)
			  	{
			  		...
			  		if (xmlhttp.responseText.search("success") != -1)
			  		{
			  			...
			  			Command: toastr["error"]("Something is wrong..", "Woops")
			  ...
			  xmlhttp.open("GET","ajax/hub.php?type=start" + "&host=" + host + "&time=" + time + "&mode=" + mode + "&method=" + method + "&head=" + head + "&ratelimit=" + ratelimit + "&cookie=" +  cookie + "&refer=" + refer + "&geo=" + geo,true);
			  xmlhttp.send();
			}
			function stop(id)
			{
			  ...
			  xmlhttp.open("POST","ajax/hub.php?type=stop" + "&id=" + id,true);
			  xmlhttp.send();
			}
		</script>
		<script>
		...
		<p id="divall" style="display:inline"></p>
		<p id="div" style="display:inline"></p>
		<img id="image" style="display:none"/>
		<?php
		if($cooldown == 1)
		{
			echo '<div class="alert alert-danger" role="alert"> Please be patient and wait for the cooldown to end.</div>';
		}
		?>		
		<div class="row">		
			<div class="col-sm-5">
				...
				<div class="card">
					<div class="card-body">
						<form method="POST">
							...
							<div class="form-group"><label for="time">Attack Time</label><input disabled="" class="form-control" id="time" name="time"  value="0" oninput="this.id.timeRange.value=this.value"><input class="custom-range mt-1" min="0" max="3600"  oninput="this.form.time.value=this.value" type="range"></div>
							<button class="btn btn-secondary btn-rounded waves-effect waves-light col-sm-12 align-center collapsed" type="button" data-toggle="collapse" data-target="#setting" aria-expanded="false" aria-controls="setting">
							...
							<div class="form-group row">
								<div class="col-sm-6">									
									<blockquote>Request Method</blockquote>
								...
								<div class="col-sm-6">								
									...
									<select id="ratelimit" class="form-control" id="basic-select">
						...
						<div class="form-group">									
							...
							<select class="form-control" id="mode" name="mode">
								<optgroup label="Basic Mode">
									...
									<optgroup label="Premium Mode(soon)">
										<?php
							...
							<div class="form-group">								
								<blockquote for="geo">Country select</blockquote>
							...
							<table class="table table table-bordered mb-0">
								<thead>
									<tr>
										...
										<th style="font-size: 12px;">Ratelimit</th>
								...
								<tbody>
									...
									while ($show = $SQLSelect->fetch(PDO::FETCH_ASSOC)) {
										...
										<tr>
											...
											<td style="font-size: 12px;"><?php echo $method; ?></td>
											<td style="font-size: 12px;"><?php echo $mode; ?></td>
											<td style="font-size: 12px;"><?php echo $ratelimit; ?></td>
